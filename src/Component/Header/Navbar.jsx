            ...
            <nav className='text-white bg-[#e72e77] py-4  md:h-18 flex  items-center'>
                <div className='md:flex md:justify-between lg:justify-around items-center w-full px-2 md:px-0 '>
                    <div className='flex justify-between items-center px-1 relative md:static'>
                        ...
                        <span onClick={() => {
                            document.querySelector('.show').classList.toggle('opacity-0');
                            document.querySelector('.show').classList.toggle('opacity-100');
                        }}>
                    ...
                    <div className='opacity-0 md:opacity-100 transition-opacity ease-in duration-300 show absolute left-0  w-full md:w-auto bg-[#e72e77] md:static z-10' >
